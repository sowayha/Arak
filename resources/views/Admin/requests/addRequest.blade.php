...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title"> طلب  جديد </h4><br>
        ...
        <select name="service_id" class="form-select" aria-label="Default select example">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="description" class="form-control @error('email') is-invalid @enderror" type="text" value="{{ old('description') }}" required autocomplete="description"></textarea>
