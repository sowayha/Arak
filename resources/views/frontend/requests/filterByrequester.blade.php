...
<div class="container d-md-flex">
  ...
  <input type="search" id="form1" class="form-control" placeholder=" البحث " aria-label="Search" />
        ...
        @if ($filterByrequester->isEmpty())
        <h4> لا يوجد نتائج للبحث </h4>
        @else

        @foreach($filterByrequester as $item)
  ...
  <div class="card-body">
    ...
    <a href="" class="btn btn-outline-primary"> التكلفة: {{$item->cost}} ريال </a>
...
<div class="pagination-wrap">
    {{ $filterByrequester->links('vendor.pagination.custom') }}
    </div>
